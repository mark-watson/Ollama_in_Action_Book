# Using the Unsloth Library on Google Colab to FineTune a 3B Model for Ollama Using a Arizona Activities Dataset

This example is similar to that in the last chapter using the same fine tuning data that I created for Arizona activities but here we fine tune a 3B model.
