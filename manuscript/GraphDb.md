...
The example shown here is derived from an example in the LangChain documentation: [https://python.langchain.com/docs/integrations/graphs/kuzu_db/](https://python.langchain.com/docs/integrations/graphs/kuzu_db/). I modified the example to use a local model running on Ollama instead of the OpenAI APIs. Here is the file **graph_kuzu_property_example.py**:
